...
public class TagInfoTool extends BasicActivity {
    ...
    private void updateTagInfo(Tag tag) {
        ...
        if (tag != null) {
            ...
            String uid = KeyUtils.byte2HexString(tag.getId());
            ...
            String atqa = KeyUtils.byte2HexString(atqaBytes);
            // SAK in big endian.
            ...
            if (sakBytes[0] != 0) {
                sak = KeyUtils.byte2HexString(sakBytes);
            } else {
                sak = KeyUtils.byte2HexString(new byte[] {sakBytes[1]});
            }
            String ats = "-";
            ...
            if (iso != null ) {
                ...
                if (atsBytes != null && atsBytes.length > 0) {
                    ats = KeyUtils.byte2HexString(atsBytes);
                }
            }
            // Identify tag type.
